...
| tab | One page of the window: *Profiles*, *General*, *Shadows / Reflections*, *Planets*, *Effects*, *Audio*, *Gameplay*, *System*, *Input*, *Keys*, *Axes*, *Mods / Toolbar*. The last one is titled *Mods and toolbar (!)* while a mod has settings the window cannot show. |
