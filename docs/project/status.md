...
| Release | A public home for CKAN's `$kref` and the version file's `URL`; how to state the licence exceptions to CKAN | [development/packaging.md](../development/packaging.md) |
