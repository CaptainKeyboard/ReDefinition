...
behind it, the window is as see-through as KSP's own dialogs, and the rows are written
with a shadow under them so that they read against a bright sky or snow.
