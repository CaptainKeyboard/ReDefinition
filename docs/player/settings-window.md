...
| What the upscaler receives | switches for a bug report, each explained by its tooltip: Jitter; EVE clouds: jitter and motion vectors, not saved; Mipmap bias; DLSS preset, not saved; Vessel motion vectors, not saved; Skinned motion vectors; TUFX after upscaling; Auto exposure for FSR 3 and AMD; Transparency mask and Reactive mask for FSR 3 |
